...
while command != "Finish":
    ...
    current_presentation_grade_average = current_presentation_grade / number_of_jury
    print(f"{current_presentation_name} - {current_presentation_grade_average:.2f}.")
    final_grade += current_presentation_grade_average
    command = input()
